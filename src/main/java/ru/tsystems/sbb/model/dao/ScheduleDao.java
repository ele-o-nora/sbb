...
public interface ScheduleDao {
    ...
    /**
     * Gets from database station that has specific name.
    ...
    /**
     * Gets from database list of stations that are reachable from both origin
     *  and destination via existing routes.
